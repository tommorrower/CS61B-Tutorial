...
public class Model extends Observable {
    ...
    public boolean MoveColumn(int x){
        ...
        Tile t0 = board.tile(x,0);
        Tile t1 = board.tile(x,1);
        Tile t2 = board.tile(x,2);
        Tile t3 = board.tile(x,3);
